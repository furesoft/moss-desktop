...
from .reader.reader import TaggedBlockReader, MainBlockInfo
from .writer.writer import TaggedBlockWriter
...
class UnreadableBlock(Block):
    ...
    def __init__(self, error: str, data: bytes, info: MainBlockInfo):
        super().__init__()
        self.error = error
        self.data = data
        self.info = info
...
class SceneInfo(Block):
    ...
    def __init__(
        ...
        self.root_document_visible = root_document_visible
...
class AuthorIdsBlock(Block):
    ...
    def __init__(self, author_uuids: dict[int, UUID]):
...
class MigrationInfoBlock(Block):
    ...
    def __init__(self, migration_id: CrdtId, is_device: bool, unknown: bool = False):
...
class TreeNodeBlock(Block):
    ...
    def __init__(self, group: si.Group):
        self.group = group
...
class PageInfoBlock(Block):
    ...
    def __init__(
        ...
        self.type_folio_use_count = type_folio_use_count
...
class SceneTreeBlock(Block):
    ...
    def __init__(self, tree_id: CrdtId, node_id: CrdtId, is_update: bool, parent_id: CrdtId):
...
class SceneItemBlock(Block):
    ...
    def __init__(self, parent_id: CrdtId, item: CrdtSequenceItem, *, extra_data: bytes = b""):
        self.parent_id = parent_id
        self.item = item
        self.extra_data = extra_data
...
class RootTextBlock(Block):
    ...
    def __init__(self, block_id: CrdtId, value: si.Text):
